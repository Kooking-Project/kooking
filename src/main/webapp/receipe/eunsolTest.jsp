...
<body>
    ...
    <div id="preloader">
 	...
 	<!-- 레시피 등록하기 Start -->
	<form name="writeForm" method="post" action="${path}/front?key=recipe&methodName=insert"
	...
	<div class="cont_box pad_l_60">
      ...
      <div>
      	...
      	<span>
      		<input type="file" name="recipe_thumbnail" style='background-color:transparent;  border:0px transparent solid; font-size:12px; width:20%;'>
      	</span>
      </div>
      <hr>
      <!-- 레시피제목 end -->		
   ...
   <!-- 요리정보 start -->
      ...
      <div>
      	...
      	<span class="guide">분류를 바르게 설정해주시면, 이용자들이 쉽게 레시피를 검색할 수 있어요.</span>
        	<div class="container">
            	<div class="row">
                	<div class="col-12 col-lg-3">				
						<select name="recipe_nation" id="recipe_nation" onchange="SetSelectBox();">
					...
					<div class="col-12 col-lg-3">
						<select name="recipe_type" id="recipe_type" onchange="SetSelectBox();">
					...
					<div class="col-12 col-lg-3">
						<select name="recipe_level" id="recipe_level" onchange="SetSelectBox();">
    ...
    <div>
        ...
        <jsp:include page="eunsolTest2.jsp"/>
   	</div>
   	<hr>
	<!-- 재료등록 END -->
