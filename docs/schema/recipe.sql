...
INSERT INTO POSTS(POST_NO,POST_TYPE_NO,USER_NO,POST_TITLE,POST_CONTENTS,POST_VIEW_COUNTS,POST_DATE) VALUES(POST_NO_SEQ.NEXTVAL, 1, (여기는 유저의 유저 번호를 입력해주세요), '여행이 가고싶은건지 젤라또가 먹고싶은건지 싶을땐','유럽에서 먹은 그 젤라또를 홈메이드로 만들어보아요', 0, SYSDATE); 
...
INSERT INTO RECIPES(RECIPES_NO,RECIPES_NANE,POST_NO,RECIPES_CALORIE,RECIPES_COOKING_TIME,RECIPES_NATION,RECIPES_TYPE,RECIPES_LEVEL,RECIPE_THUMBNAIL) VALUES(RECIPES_NO_SEQ.NEXTVAL,'잣국수',3, 513, 20, '한식', '만두/면류', '초보환영','RECIPE_DEFAULT.PNG');
INSERT INTO RECIPES(RECIPES_NO,RECIPES_NANE,POST_NO,RECIPES_CALORIE,RECIPES_COOKING_TIME,RECIPES_NATION,RECIPES_TYPE,RECIPES_LEVEL,RECIPE_THUMBNAIL) VALUES(RECIPES_NO_SEQ.NEXTVAL,'마늘빵',4, 276, 15, '서양', '빵/과자', '초보환영','RECIPE_DEFAULT.PNG');
INSERT INTO RECIPES(RECIPES_NO,RECIPES_NANE,POST_NO,RECIPES_CALORIE,RECIPES_COOKING_TIME,RECIPES_NATION,RECIPES_TYPE,RECIPES_LEVEL,RECIPE_THUMBNAIL) VALUES(RECIPES_NO_SEQ.NEXTVAL,'순두부찌개',5, 253, 30, '한식', '찌개/전골/스튜', '보통','RECIPE_DEFAULT.PNG');
INSERT INTO RECIPES(RECIPES_NO,RECIPES_NAME,POST_NO,RECIPES_CALORIE,RECIPES_COOKING_TIME,RECIPES_NATION,RECIPES_TYPE,RECIPES_LEVEL,RECIPE_THUMBNAIL) VALUES(6,'팟타이',15, 350, 20, '동남아시아', '볶음', '초보환영');
INSERT INTO RECIPES(RECIPES_NO,RECIPES_NAME,POST_NO,RECIPES_CALORIE,RECIPES_COOKING_TIME,RECIPES_NATION,RECIPES_TYPE,RECIPES_LEVEL,RECIPE_THUMBNAIL) VALUES(RECIPES_NO_SEQ.NEXTVAL,'크림소스 치킨스테이크',POST_NO_SEQ.CURRVAL, 433, 30, '서양', '양식', '보통','RECIPE_DEFAULT.PNG');
