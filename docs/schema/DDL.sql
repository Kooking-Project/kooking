...
CREATE TABLE RECIPES(
    ...
    RECIPE_THUMBNAIL VARCHAR2(600) DEFAULT 'RECIPE_DEFAULT.PNG'
);
...
CREATE TABLE PROCESS(
    PROCESS_NO 		NUMBER(30) 		PRIMARY KEY,
    RECIPES_NO 		NUMBER(20) 		REFERENCES RECIPES(RECIPES_NO) ON DELETE CASCADE  NOT NULL,
...
RECIPES_NATION, RECIPES_TYPE, RECIPES_LEVEL, NVL(SC, -1) AS SCORE, RECIPE_THUMBNAIL
...
SELECT * FROM (SELECT A.*,ROWNUM RNUM  FROM VIEW_RECIPES A WHERE USER_NO=1) WHERE RNUM BETWEEN 1 AND 5 ORDER BY POST_DATE DESC;
